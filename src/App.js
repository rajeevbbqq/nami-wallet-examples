...
export default function App() {
    ...
    const getBalance = async () => {
        ...
        try {
            ...
            const result = await nami.getBalance();
    ...
    const createPolicy = async () => {
        ...
        try {
            ...
            const newPolicy = await nami.createLockingPolicyScript(
                myAddress,
                networkId.id,
                policyExpiration
            );
        ...
        <>
            <div className="container">
                ...
                <div className="container">
                    ...
                    <div className="row">
                        <button
                            className={`button ${connected ? "success" : ""}`}
                            onClick={connect}
                        >
                            {" "}
                    ...
                    <div className="row">
                        <button
                            className={`button ${address ? "success" : ""}`}
                            onClick={getAddress}
                        >
                            {" "}
                            Get Your Address{" "}
                    ...
                    <div className="row">
                        <button
                            className={`button ${balance ? "success" : ""}`}
                            onClick={getBalance}
                        >
                            {" "}
                        ...
                        <div className="column">
                            ...
                            <div className="item address">
                                ...
                                <input
                                    ...
                                    onChange={(event) =>
                                        setRecipientAddress(event.target.value.toString())
                                    }
                                />
                            </div>
                        </div>
                ...
                <div className="row">
                    <button
                        className={`button ${complextxHash ? "success" : ""}`}
                        onClick={buildFullTransaction}
                    >
                        {" "}
                        Build Transaction
                    </button>
